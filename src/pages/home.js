      ...
      <div id="Page_container">
        ...
        <div id="aboutme">
          ...
          <p>
            ...
            through technilogiclal advancements. I have made it my soul purpose
            to leap into this fast pace
            <br />
            world, armed and dangerous, ready to contribute to those
            advancements.
          </p>
          <h1>Quick quotes</h1>
          <q>
          ...
          <q id="longQ">
            ...
            shine as children do. It's not just in some of us; it is in
            everyone. And as we let our own lights shine, we unconsciously give
            other people permission to do the same. As we are liberated from our
            own fear, our presence automatically liberates others." <br />
            —Marianne Williamson
          </q>
        </div>
        <div>
